...
# USER MODIFIABLE PARAMETERS:                                       #
 ...
 TASKS=8        # 1 core
 TIME="12:00:00" # 2 hours job running time limit
 GPU="gtx_1080:1"		# 0 GPUs for CPU cluster. Change to 1 for GPU cluster
 QOS=normal	# partition 'main' works only with QoS 'normal'
#                                                                   #
#####################################################################
#
...
#SBATCH -o $CWD/log/pycharm_session_%J.log
